...
# -*- coding: utf-8 -*-
"""
Telegram Bot РґР»СЏ AI-Agent - РРЎРџР РђР’Р›Р•РќРќРђРЇ Р’Р•Р РЎРРЇ
...
BASE_URL = os.getenv("AGENT_API_BASE", "http://127.0.0.1:8088")
SECRET = os.getenv("AGENT_HTTP_SHARED_SECRET", "")

def tg_api(method: str, **kwargs):
    """Р’С‹Р·РѕРІ API Telegram СЃ РїСЂР°РІРёР»СЊРЅРѕР№ РєРѕРґРёСЂРѕРІРєРѕР№"""
    url = f"https://api.telegram.org/bot{TOKEN}/{method}"
    try:
        # РџСЂРёРЅСѓРґРёС‚РµР»СЊРЅРѕ СѓСЃС‚Р°РЅР°РІР»РёРІР°РµРј UTF-8 РґР»СЏ requests
        headers = {
...
def send_to_agent(text: str, session: str = "Telegram") -> str:
    """РћС‚РїСЂР°РІРєР° РєРѕРјР°РЅРґС‹ Р°РіРµРЅС‚Сѓ СЃ РїСЂР°РІРёР»СЊРЅРѕР№ РєРѕРґРёСЂРѕРІРєРѕР№"""
    try:
...
def handle_message(chat_id: int, text: str):
    ...
    # РћС‚РїСЂР°РІР»СЏРµРј РѕС‚РІРµС‚ СЃ РїСЂР°РІРёР»СЊРЅРѕР№ РєРѕРґРёСЂРѕРІРєРѕР№
...
def main():
    ...
    print("рџ¤– Р—Р°РїСѓСЃРє Telegram Р±РѕС‚Р° (РРЎРџР РђР’Р›Р•РќРќРђРЇ Р’Р•Р РЎРРЇ)...")
